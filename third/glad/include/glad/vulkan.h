/**
 * Loader generated by glad 2.0.8 on Sun Jun 14 04:17:07 2026
 *
 ...
 *
 * Commandline:
 *    --api='vulkan=1.3' --extensions='VK_ANDROID_external_memory_android_hardware_buffer,VK_ARM_rasterization_order_attachment_access,VK_EXT_blend_operation_advanced,VK_EXT_buffer_device_address,VK_EXT_conservative_rasterization,VK_EXT_descriptor_indexing,VK_EXT_device_fault,VK_EXT_extended_dynamic_state,VK_EXT_extended_dynamic_state2,VK_EXT_filter_cubic,VK_EXT_frame_boundary,VK_EXT_global_priority_query,VK_EXT_graphics_pipeline_library,VK_EXT_host_image_copy,VK_EXT_index_type_uint8,VK_EXT_line_rasterization,VK_EXT_load_store_op_none,VK_EXT_memory_budget,VK_EXT_memory_priority,VK_EXT_multisampled_render_to_single_sampled,VK_EXT_pipeline_creation_cache_control,VK_EXT_pipeline_protected_access,VK_EXT_pipeline_robustness,VK_EXT_queue_family_foreign,VK_EXT_rasterization_order_attachment_access,VK_EXT_rgba10x6_formats,VK_EXT_sampler_filter_minmax,VK_EXT_shader_viewport_index_layer,VK_EXT_vertex_attribute_divisor,VK_EXT_vertex_input_dynamic_state,VK_KHR_android_surface,VK_KHR_bind_memory2,VK_KHR_buffer_device_address,VK_KHR_copy_commands2,VK_KHR_create_renderpass2,VK_KHR_dedicated_allocation,VK_KHR_depth_stencil_resolve,VK_KHR_device_group,VK_KHR_draw_indirect_count,VK_KHR_driver_properties,VK_KHR_dynamic_rendering,VK_KHR_dynamic_rendering_local_read,VK_KHR_external_memory,VK_KHR_external_memory_capabilities,VK_KHR_format_feature_flags2,VK_KHR_get_memory_requirements2,VK_KHR_get_physical_device_properties2,VK_KHR_global_priority,VK_KHR_load_store_op_none,VK_KHR_maintenance5,VK_KHR_maintenance6,VK_KHR_pipeline_library,VK_KHR_portability_enumeration,VK_KHR_push_descriptor,VK_KHR_sampler_mirror_clamp_to_edge,VK_KHR_sampler_ycbcr_conversion,VK_KHR_shader_draw_parameters,VK_KHR_shader_expect_assume,VK_KHR_shader_float_controls2,VK_KHR_shader_subgroup_rotate,VK_KHR_surface,VK_KHR_swapchain,VK_KHR_synchronization2,VK_KHR_wayland_surface,VK_KHR_win32_surface,VK_KHR_xcb_surface,VK_KHR_xlib_surface' c --loader --on-demand
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.3&generator=c&options=LOADER%2CON_DEMAND
 *
 */
